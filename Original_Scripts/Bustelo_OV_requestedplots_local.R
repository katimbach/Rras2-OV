...
plot_dir<- "./Plots/Spatial/Requested_Plots/"
...
plot_dir<- "./Plots/Spatial/Requested_Plots/Tumors_Gene_Violin/AdvCCGenes/"
...
plot_dir<- "./Plots/Spatial/Requested_Plots/Tumors_Gene_Violin/AdenoGenes/"
ifelse(!dir.exists(plot_dir), dir.create(plot_dir, recursive = T), FALSE)
...
plot_dir<- "./Plots/Spatial/Requested_Plots/Tumors_Gene_Violin/ReteGenes/"
ifelse(!dir.exists(plot_dir), dir.create(plot_dir, recursive = T), FALSE)
...
plot_dir<- "./Plots/Spatial/Requested_Plots/Tumors_Gene_Violin/EpithelialGenes/"
ifelse(!dir.exists(plot_dir), dir.create(plot_dir, recursive = T), FALSE)
